...
export class Product {
    ...
    constructor(arg1: string, arg2: unknown, arg3: unknown, arg4?: unknown) {
        if (Array.isArray(arg3)) {
            this._id = arg1;
            this._nazwa = arg2 as string;
            this._cena = new Money(0);
            this._opis = "";
            this._opinie = [];
            for (const f of arg3 as ProductFeature[]) {
                this.addFeature(f);
            }
        } else {
            this._id = crypto.randomUUID();
            this._nazwa = arg1;
            this._cena = arg2 as Money;
            this._opis = arg3 as string;
            this._opinie = (arg4 as string[]) || [];
        }
    }
    ...
    getFeatures<T extends ProductFeature>(type: new (...args: unknown[]) => T): T[] {
